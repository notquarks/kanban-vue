...
<template>
  <div
    class="flex aspect-square w-auto min-w-64 cursor-pointer flex-col rounded-md border bg-white p-4 shadow-md transition-shadow hover:shadow-lg"
  >
    <div
    ...
    <div class="flex flex-row">
      ...
      <DropdownMenuRoot v-model:open="toggleState">
        <DropdownMenuTrigger
          class="rounded-xs p-0.5 hover:cursor-pointer hover:bg-gray-200"
        >
          <EllipsisVertical />
        </DropdownMenuTrigger>
        <DropdownMenuPortal>
