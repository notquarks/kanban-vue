...
<template>
    <div class="group/card flex aspect-square w-auto min-w-64 cursor-pointer flex-col rounded-md border bg-white p-4 shadow-md transition-all duration-100 ease-linear hover:bg-gray-700 hover:text-gray-100 hover:shadow-lg"
        @click="navigateToProject(project.id)">
        <div class="mb-3 flex h-4/5 w-full rounded-md bg-gradient-to-br from-blue-500 to-blue-600" />
        <div class="flex flex-row">
            <div class="flex-1">
                <h3 class="truncate font-semibold text-gray-900 group-hover/card:text-gray-50">
                    {{ project.name }}
                </h3>
